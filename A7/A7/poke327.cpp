...
class CSV{
  ...
  void readFile(const string& fname){
    ...
    num_columns = count(line.begin(), line.end(), ',') + 1;
    file.seekg(0);
  ...
  if (argc > 1)
  {
    for (i = 1, long_arg = 0; i < argc; i++, long_arg = 0)
    {
      if (strcmp(argv[i], "pokemon") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/pokemon.csv";
        fstream file (fname, ios::in);

        if(!file.is_open())
        {
          cout<<"Could not open the file\ntrying next method to open file\n";
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/pokemon.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
          }
        }

        CSV pokemonCSV;
        pokemonCSV.readFile(fname);
      ...
      if (strcmp(argv[i], "moves") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/moves.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/moves.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
      ...
      if (strcmp(argv[i], "pokemon_moves") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/pokemon_moves.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/pokemon_moves.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
        ...
        CSV pokemon_movesCSV;
        pokemon_movesCSV.readFile(fname);
      ...
      if (strcmp(argv[i], "pokemon_species") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/pokemon_species.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/pokemon_species.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
        ...
        CSV pokemon_speciesCSV;
        pokemon_speciesCSV.readFile(fname);
      ...
      if (strcmp(argv[i], "experience") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/experience.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/experience.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
      ...
      if (strcmp(argv[i], "type_names") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/type_names.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/type_names.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
      ...
      if (strcmp(argv[i], "pokemon_stats") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/pokemon_stats.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/pokemon_stats.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
        ...
        CSV pokemon_statsCSV;
        pokemon_statsCSV.readFile(fname);
      ...
      if (strcmp(argv[i], "stats") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/stats.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/stats.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
      ...
      if (strcmp(argv[i], "pokemon_types") == 0){
        string fname = "/share/cs327/pokedex/pokedex/data/csv/pokemon_types.csv";
        fstream file (fname, ios::in);
        ...
        if(!file.is_open())
        {
          ...
          usleep(500000);
          const char* homeDir = getenv("HOME");
          fname = string(homeDir) + "/.poke327/pokemon_types.csv";
          fstream file (fname, ios::in);
          if(!file.is_open()){
            cout<<"All methods to open file failed\n";
            return 0;
        ...
        CSV pokemon_typesCSV;
        pokemon_typesCSV.readFile(fname);
